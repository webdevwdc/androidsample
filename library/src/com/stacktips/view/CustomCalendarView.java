...
//        calendarBackgroundColor = typedArray.getColor(R.styleable.CustomCalendarView_calendarBackgroundColor, getResources().getColor(R.color.normal_date_backgroundcolor));

//        calendarTitleBackgroundColor = typedArray.getColor(R.styleable.CustomCalendarView_titleLayoutBackgroundColor, getResources().getColor(R.color.month_title_backgroundcolor));
...
//        weekLayoutBackgroundColor = typedArray.getColor(R.styleable.CustomCalendarView_weekLayoutBackgroundColor, getResources().getColor(R.color.week_title_backgroundcolor));
...
//        selectedDayTextColor = typedArray.getColor(R.styleable.CustomCalendarView_selectedDayTextColor, getResources().getColor(R.color.white));
        ...
        calendarBackgroundColor = ContextCompat.getColor(mContext, R.color.normal_date_backgroundcolor);
        calendarTitleBackgroundColor= ContextCompat.getColor(mContext, R.color.month_title_backgroundcolor);
        weekLayoutBackgroundColor=ContextCompat.getColor(mContext, R.color.week_title_backgroundcolor);
        calendarTitleTextColor=ContextCompat.getColor(mContext, R.color.white);
        dayOfWeekTextColor=ContextCompat.getColor(mContext, R.color.black);
        dayOfMonthTextColor=ContextCompat.getColor(mContext, R.color.black);

        selectedDayBackground=ContextCompat.getColor(mContext, R.color.available_date_backgroundcolor);
        selectedDayTextColor=ContextCompat.getColor(mContext, R.color.white);
    ...
    private void initializeTitleLayout() {
        ...
        int dateText2 = currentCalendar.get(Calendar.YEAR);
...
//        dateTitle.setText(dateText + " " + currentCalendar.get(Calendar.YEAR));
        dateTitle.setText(dateText+" "+dateText2);
        dateTitle.setTextColor(calendarTitleTextColor);
//        if (null != getCustomTypeface()) {
//            dateTitle.setTypeface(getCustomTypeface2(), Typeface.NORMAL);
...
//        }
    ...
    private void initializeWeekLayout() {
        ...
        for (int i = 1; i < weekDaysArray.length; i++) {
            ...
            dayOfWeek.setTextColor(ContextCompat.getColor(mContext, R.color.white));

           /* if (null != getCustomTypeface2()) {
                dayOfWeek.setTypeface(getCustomTypeface2());
            }*/
        }
    }
...
//                dayView.setBackgroundColor(calendarBackgroundColor);
                dayView.setBackgroundDrawable(ContextCompat.getDrawable(mContext, R.drawable.custom_day_back_normal));
...
//            dayView.setBackgroundColor(calendarBackgroundColor);
    ...
    public void markDayAsCurrentDay(Calendar calendar) {
        if (calendar != null && CalendarUtils.isToday(calendar)) {
            ...
            markDayAsSelectedDay(Calendar.getInstance().getTime());
        }
    }
...
//        view.setBackgroundColor(selectedDayBackground);
        view.setBackgroundDrawable(ContextCompat.getDrawable(mContext, R.drawable.custom_day_back_available));
    ...
    private OnClickListener onDayOfMonthClickListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (!CalendarUtils.isPastDay(calendar.getTime())) {

                markDayAsSelectedDay(calendar.getTime());
            }
            else{
                dayOfMonthText.setTextColor(disabledDayTextColor);
            }
...
//        Typeface custom_font = Typeface.createFromAsset(mContext.getAssets(),  "fonts/CaviarDreams.ttf");
//        text_header.setTypeface(custom_font);
