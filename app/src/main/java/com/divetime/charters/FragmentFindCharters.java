 ...
 */
public class FragmentFindCharters extends Fragment {
    ...
    public static FragmentFindCharters newInstance(String param1, String param2) {
        FragmentFindCharters fragment = new FragmentFindCharters();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_find_charters, container, false);
    ...
    private void initView(View view)
    {
        ...
        toolbar_header.setText("Find a Charter");
        ...
        tv_site_name.setText("Upcoming for "+mParam2);
