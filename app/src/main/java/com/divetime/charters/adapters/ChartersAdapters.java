...
import com.divetime.databinding.RowChartersBinding;
...
public class ChartersAdapters extends RecyclerView.Adapter<ChartersAdapters.MyViewHolder> {
    private Context mContext;
    private List<CharterListingDatum> al_data;
    RowChartersBinding binding;

    public ChartersAdapters(List<CharterListingDatum> _data, Context ctx) {
        if(ctx!=null) {
            mContext = ctx;
            this.al_data = _data;
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        RowChartersBinding mBinding;
        public MyViewHolder(View view) {
            super(view);
            mBinding= DataBindingUtil.bind(view);
            mBinding.setAdapter(ChartersAdapters.this);
        }
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        binding = DataBindingUtil.inflate(LayoutInflater.from(mContext), R.layout.row_charters, parent, false);
